        ...
        <div class="row gy-4 align-items-center">
          <div class="col-lg-6 order-2 order-lg-1">
            <div class="hero-content">
              <h1 data-aos="fade-up" data-aos-delay="200">Hello, I'm <span class="highlight">Izza Wildan R</span></h1>
              <h2 data-aos="fade-up" data-aos-delay="300">Creative <span class="typed" data-typed-items="Fullstack Web Developer, Backend Developer, Frontend Developer"></span></h2>
              <p data-aos="fade-up" data-aos-delay="400"> I build web apps, manage databases, and design digital experiences. Combining technical precision with creative thinking, I help transform ideas into impactful solutions.</p>
          ...
          <div class="col-lg-6 order-1 order-lg-2">
            <div class="hero-image" data-aos="zoom-in" data-aos-delay="300">
              <div class="image-wrapper">
                <img src="{{asset('img/profile/wildan.webp')}}" alt="Sarah Mitchell" class="img-fluid">
